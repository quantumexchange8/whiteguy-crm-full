            ...
            <div class="form-input-section dark:bg-dark-eval-1">
                ...
                <div class="input-group-wrapper">
                    <div class="input-group">
                        <table class="table sale-orders-table text-sm">
                            <thead class="bg-gray-600 text-gray-300 rounded-md">
                                <tr class="w-full">
                                    <th scope="col">IN/OUT <span class="text-red-500">*</span></th>
                                    <th scope="col">PRODUCT <span class="text-red-500">*</span></th>
                                    <th scope="col">PRICE <span class="text-red-500">*</span></th>
                                    <th scope="col">US$/EU <span class="text-red-500">*</span></th>
                                    <th scope="col">QUANTITY <span class="text-red-500">*</span></th>
                                    <th scope="col">SUBTOTAL <span class="text-red-500">*</span></th>
                                    <th scope="col">COMMISSION % <span class="text-red-500">*</span></th>
                                    <th scope="col">COMMISSION <span class="text-red-500">*</span></th>
                                    <th scope="col">TOTAL EU <span class="text-red-500">*</span></th>
                                    <th scope="col">TOTAL US$ <span class="text-red-500">*</span></th>
                                </tr>
                            </thead>
